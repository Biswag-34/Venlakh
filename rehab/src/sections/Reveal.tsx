  ...
  return (
    <section className="relative w-full bg-[#0e1110] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
        ...
        {/* line 1 – top */}
        <motion.div
          className="absolute top-1/2 flex whitespace-nowrap text-[40px] md:text-[100px] xl:text-[120px] font-bold text-white/10 -translate-y-[160px] max-md:-translate-y-[80px]"
        ...
        {/* line 2 – middle */}
        <motion.div
          className="absolute top-1/2 flex whitespace-nowrap text-[40px] md:text-[100px] xl:text-[120px] font-bold text-white/10 translate-y-0"
          style={{ willChange: "transform" }}
          animate={{ x: ["0%", "-50%"] }}
        ...
        {/* line 3 – bottom */}
        <motion.div
          className="absolute top-1/2 flex whitespace-nowrap text-[60px] md:text-[120px] font-bold text-white/10 -translate-y-1/2 translate-y-[140px] max-md:translate-y-[70px]"
          style={{ willChange: "transform" }}
          animate={{ x: ["0%", "-50%"] }}
